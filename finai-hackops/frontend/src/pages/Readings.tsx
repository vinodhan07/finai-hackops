...
export default function Readings() {
      ...
      setReadings([
        {
          ...
          meter_number: "ELE-12345",
          current_reading: 1250.5,
          previous_reading: 1100.2,
          consumption: 150.3,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.info("Reading management will be fully enabled soon (currently local only)");
      ...
      if (editingReading) {
        setReadings(readings.map(r =>
          r.id === editingReading.id
            ? { ...r, ...formData, current_reading: currentReading, previous_reading: previousReading, consumption, cost_per_unit: costPerUnit, total_cost: totalCost }
            : r
        ));
