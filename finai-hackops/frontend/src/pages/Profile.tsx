...
const Profile = () => {
  ...
  const [userInfo, setUserInfo] = useState({
    name: user?.full_name || user?.username || "FinAI User",
    email: user?.email || "",
    phone: "+91 99999 99999",
    location: "India",
    joinDate: "Jan 2025",
    bankName: "HDFC Bank",
    accountNumber: "50100456XXX",
    ifscCode: "HDFC0001234",
    accountType: "Savings",
    cibilScore: "785",
    cibilLastUpdated: "2025-01-10"
  });
  ...
  const handleSaveProfile = async () => {
    // Placeholder for when we have a profile update API
            ...
            <Card className="gradient-card shadow-card border-0">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-card-foreground text-lg">Credit Information</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="cibilScore" className="flex items-center">
                      ...
                      <Input
                        ...
                        value={userInfo.cibilScore}
                        onChange={(e) => setUserInfo({ ...userInfo, cibilScore: e.target.value })}
                        disabled={!isEditing}
                        min="300"
                        max="900"
                      />
                      {userInfo.cibilLastUpdated && (
                        <p className="text-xs text-muted-foreground">
                          Last updated: {userInfo.cibilLastUpdated}
                        </p>
                      )}
                    </div>
                  </div>
